...
<div style="display: flex; flex-wrap: wrap; justify-content: center; max-width: 100%;">
    ...
    <img style="border:5px solid black; margin: 5px; flex: 1 1 20%; max-width: 20%;" src="../images/range.jpg" alt="range">
    <img style="border:5px solid black; margin: 5px; flex: 1 1 20%; max-width: 20%;" src="../images/day.jpg" alt="day">
    <img style="border:5px solid black; margin: 5px; flex: 1 1 20%; max-width: 20%;" src="../images/select.jpg" alt="select">
    <img style="border:5px solid black; margin: 5px; flex: 1 1 20%; max-width: 20%;" src="../images/start.jpg" alt="start">
    <img style="border:5px solid black; margin: 5px; flex: 1 1 20%; max-width: 20%;" src="../images/end.jpg" alt="end">
    <img style="border:5px solid black; margin: 5px; flex: 1 1 20%; max-width: 20%;" src="../images/break.jpg" alt="break">
    <img style="border:5px solid black; margin: 5px; flex: 1 1 20%; max-width: 20%;" src="../images/login.jpg" alt="login">
    <img style="border:5px solid black; margin: 5px; flex: 1 1 20%; max-width: 20%;" src="../images/join.jpg" alt="join">
</div>
...
<div style="display: flex; flex-wrap: wrap; justify-content: center; max-width: 100%;">
    ...
    <img style="border:5px solid black; margin: 5px; flex: 1 1 20%; max-width: 20%;" src="../images/CarProfilePage.png" alt="Car Profile Page">
    <img style="border:5px solid black; margin: 5px; flex: 1 1 20%; max-width: 20%;" src="../images/CarSignInPage.png" alt="Car Sign-In Page">

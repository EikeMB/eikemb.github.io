...
📱 A project that I am currently working on is a device that helps on a sailing race. The user would be able to set the start line position
and the timer, then based on the boat speed a estimate of how long you will need to get to the line is shown. I had already made a mobile application for this and am now working on making a race legal version with a microprocessor and sensors.
...
2024 - Current: Concordia University, Computer Science Bachelor
...
2025 - current: Junior Software Specialist at RheEnergise

- Designed and Developed control systems for test rigs as well as demonstrator project.

2024 – 2025: Intern working with the R&D Engineering team at RheEnergise
